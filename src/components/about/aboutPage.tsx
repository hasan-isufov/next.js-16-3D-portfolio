...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "hsnsvs.work@gmail.com",
    href: "mailto:hsnsvs.work@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "07737407394",
    href: "tel:07737407394",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/hasan-isufov-a8043a313/",
    content: "/hasan-isufov",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/hasan-isufov",
    content: "/hasan-isufov",
